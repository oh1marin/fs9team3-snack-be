...
ssh -i "경로/키.pem" ec2-user@13.209.21.15
...
2. EC2로 전송:
   ```powershell
   scp -i "C:\Users\marin\Downloads\marin-pem-key.pem" fs9team3-snack-be.zip ec2-user@13.209.21.15:~/
   ```
3. EC2에서:
   ```bash
   cd ~
